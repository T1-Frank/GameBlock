...
$db = mysqli_connect("localhost","root","","my_storedb");
...
function getPCats(){
    ...
    $get_p_cats = "select * from product_categories LIMIT 0,5";
...
function getCats(){
    ...
    $get_cats = "select * from categories LIMIT 0,5";
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1> No Product Found Under This Category </h1>
